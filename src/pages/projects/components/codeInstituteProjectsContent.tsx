export function HowToBuildATreeHouseContent() {
  return (
    <>
      ...
      &nbsp;
      <a
        href="https://alexrobincrabbe.github.io/build_a_treehouse/"
        target="_blank"
        className="ext-link"
      >
        Site
...
export function MonstoryumContent() {
  return (
    <>
      ...
      <br />
      <a
        href="https://github.com/alexrobincrabbe/MonStoryum"
        target="_blank"
        className="ext-link"
      >
        Source code
...
export function DiagnosticToolContent() {
  return (
    <>
      ...
      <br />
      <a
        href="https://github.com/alexrobincrabbe/Brain_tumour_diagnostic"
        target="_blank"
        className="ext-link"
      >
        Source code
