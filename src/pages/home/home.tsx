        ...
        <div className="flex flex-wrap justify-center items-center h-full">
          ...
          <div className="order-3 md:order-1 w-full">
            <p className="text-2xl">
              Originally from England, I relocated to Germany in 2010. I earned
              a Master’s degree in Physics in 2023, during which I gained
              substantial experience with programming, particularly using MATLAB
              for my thesis work. This experience lit the spark for a deeper
              dive into software development, so after graduating I pivoted into
              software development. I completed an intensive full-stack
              development course in 2024. I’ve since poured energy into a
              passion project: a multiplayer online word game platform that
